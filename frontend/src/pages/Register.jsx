    ...
    <div className="backdrop-blur-lg flex mx-auto w-fit flex-col items-center justify-center px-4 relative z-10">
      ...
      >
        ...
        <input
          ...
          className="w-full mb-4 px-4 py-2 border bg-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          required
        />
        <input
          name="email"
        ...
        <input
          ...
          value={form.password}
          onChange={handleChange}
          className="w-full mb-6 px-4 py-2 border bg-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          required
        />
